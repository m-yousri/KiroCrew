...
import { Boxes, FolderOpen, Database, Sparkles, Plus, MessageSquare, Users, LayoutGrid, Rows3, UserPen } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-x-3 gap-y-2 border-t border-border pt-3">
        <Binding icon={<Boxes className="lucide-inline" aria-hidden="true" />} label={i18nT('pages.kiroCrewAgentsPage.custom_agent')} value={agent.kiro_agent} />
            ...
            <Table>
              <TableHeader>
                <TableRow className="hover:bg-transparent">
                  ...
                  <TableHead>{i18nT('pages.kiroCrewAgentsPage.custom_agent')}</TableHead>
