  ...
  return (
    ...
    <div className="flex h-full min-h-0" data-testid="members-page">
      ...
      {active && (() => {
          ...
          // Notes — the crewmate's own standing notes, read-only here. Its
          // briefing read is gated on the tab being on screen, like the work
          // log's reads. Edit opens the file in this panel's file viewer
          // (`openFile`), the dashboard's one editor for files on disk.
