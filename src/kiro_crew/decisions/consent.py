...
transcript tail and a forge comment's body). A ceiling sits beside them --
...
#: AND THIRD PARTIES -- a watched worker's transcript tail, a bot's review comment
#: body, a work-ledger event -- the category ``nudge.wake`` needs and no other
